    ...
    if (deviceOrientation == Orientation.portrait) {
      return ListView.builder(
        itemBuilder: (BuildContext context, int index) {
          ...
          return CategoryTile( //Pasamos el category y el onTap segun definimos en category_tile ya no es obligatorio
            category: _category,
            onTap:
                _category.name == apiCategory['name'] && _category.units.isEmpty //si category viene del api y no hay units el onTap será null , sino permitir el tap para setear el _currentCategory
                    ? null
                    : _onCategoryTap,
          );
        },
