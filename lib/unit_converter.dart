...
class _UnitConverterState extends State<UnitConverter> {
  ...
  Future<void> _updateConversion() async {
    ...
    if (widget.category.name == apiCategory['name']) {
      ...
      // API error or not connected to the internet (es decir si conversion == null)
      if (conversion == null) {
        setState(() {
          _showErrorUI = true; //mostrar error
        });
      } else { //sino setear normal
        setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    } //termina el if. Es decir si units == null o si (viene del api y se activa mostrar error) se muestra el SingleChildScrollView
